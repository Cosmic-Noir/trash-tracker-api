...
CREATE TABLE tt_sites (
    id INTEGER PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    postedBy INTEGER REFERENCES tt_users(id) ON DELETE CASCADE NOT NULL,
...
CREATE TABLE tt_comments (
    id INTEGER PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    userRef INTEGER REFERENCES tt_users(id) ON DELETE CASCADE NOT NULL,
    siteId INTEGER REFERENCES tt_sites(id) ON DELETE CASCADE NOT NULL,
    date_posted TIMESTAMP DEFAULT now() NOT NULL,
    content TEXT NOT NULL
